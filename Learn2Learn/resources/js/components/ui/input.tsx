  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        ...
        ref={ref}
        className={cn(
          "border-[#4DB6AC]/30 bg-white text-[#263238] focus:border-[#00796B] focus:ring-[#00796B]/20 dark:border-[#4DB6AC]/20 dark:bg-[#263238]/60 dark:text-[#E0F2F1] dark:focus:border-[#4DB6AC] dark:focus:ring-[#4DB6AC]/30",
